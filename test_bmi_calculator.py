from bmi_cal import calculateBMI, categoryBMI
...
def test_calculate_bmi():
    assert calculateBMI(67, 110) == '17.6'    # underweight
    assert calculateBMI(63, 125) == '22.7'    # normal
    assert calculateBMI(61, 150) == '29.0'    # overweight
    assert calculateBMI(61, 250) == '48.4'    # obese
